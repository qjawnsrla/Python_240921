# 인스턴스 메소드 : 객체로 만들어질 때 함께 만들어지는 메소드
# 정적 메소드 : 클래스와 관련이 있음, 객체와 무관한 독립적인 동작 수행
# 클래스 메소드 : 클래스와 관련 있음, 클래스 변수를 사용하기 위함
class Car:
    is_instance_cnt = 0     # 클래스 변수 (멤버 변수), 클래스 소속, 객체로 만들어지지 않음
    ...
    @classmethod
    def print_cnt(cls):     # 클래스 변수에 대한 접근을 하고자 하는 경우 사용
